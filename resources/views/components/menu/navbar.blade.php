{{-- top bar --}}
<div class="fixed top-0 left-0 z-50 flex items-center justify-between w-full h-16 px-4 bg-white shadow grow-0 lg:hidden">
...
<nav
    ...
    class="fixed bg-white shadow-xl flex lg:!flex flex-col justify-between lg:relative top-0 z-50 flex-grow-0 h-screen transition-all duration-200 transform lg:!left-0 pt-0 w-80"
>
